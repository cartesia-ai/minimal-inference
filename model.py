"""
Minimal from-scratch transformer implementation for Qwen2 and Mistral models.
...
def load_weights(
    model: Model, model_path: str, device: str = "cpu", dtype: torch.dtype = torch.bfloat16
) -> None:
